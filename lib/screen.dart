...
class ScreenInstagramFetcher extends StatefulWidget {
  final String header;
  final String helperText;
  final Function(Map<String, List<String>>) onData;
  final String buttonLabel;

  const ScreenInstagramFetcher({
    Key key,
  ...
  @override
  _ScreenInstagramFetcherState createState() => _ScreenInstagramFetcherState();
}

class _ScreenInstagramFetcherState extends State<ScreenInstagramFetcher> {
              ...
              RaisedButtonWithLoader(
                ...
                onPressed: () async {
                  ...
                  if (!form.validate()) {
                    ...
                    var map = await ig.getInstagramPhoto(igController.text);
                    widget.onData(map);
                    setState(() {
                      isLoading = false;
                    });
